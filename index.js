...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'http://localhost:1234', 'myflixbysarah.netlify.app', 'http://localhost:4200', 'https://sarahmjenkins.github.io/'];
app.use(cors({
